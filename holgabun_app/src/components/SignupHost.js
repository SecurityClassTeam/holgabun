    ...
    <div>
      ...
      <form class="submit" onSubmit={onSubmit}>
        ...
        <ul>
          ...
          <li>
            2. 호스팅 소득의 신고 의무 여부는 국세청에서 확인하시기 바랍니다.
            대금 결제 내역에서 확인하실 수 있습니다.
          </li>
        </ul>
        <h6>계약에 따른 합의 및 허가</h6>
        <ul>
          <li>
            1. 임대차 계약, 부동산 계약, 건물 규정 및 주민회의 규정에서 재임대나
            호스팅을 제한하는 경우가 있습니다. 체결한 계약 내용을 검토하거나
            임대인, 입주자 협의회에 확인해 보시길 바랍니다.
          </li>
          <li>
        ...
        <ul>
          <li>
            호스트는 법규을 위반하는 어떠한 행위를 해서는 안됩니다. '홀가분'은
            호스트의 법규 위반에 책임지지 않습니다.
          </li>
        </ul>
        <h6>주택담보대출 제한</h6>
        <ul>
          <li>
            주택담보대출(또는 다른 대출)을 이용하고 있는 경우, 재임대나 호스팅에
            대한 제한이 없는지 대출 기관에 확인하시기 바랍니다.
          </li>
        </ul>
        <h6>정부 보조 주택 제한</h6>
        <ul>
          <li>
            ...
            일반적으로 금지됩니다. 정부 보조 주택에서 거주하고 호스팅에 관심이
            있는 경우, 주택 관리 기관에 문의하시기 바랍니다.
          </li>
        </ul>
        <h6>법규 위반 및 악용</h6>
        <ul>
          <li>
            위반 및 악용에 대한 신고가 있을 경우, '홀가분'은 해당 사용자에 대한
            적절한 조치를 취할 것입니다.
          </li>
        </ul>
        <h6>배상 책임 및 기본 보장</h6>
        <ul>
          <li>
            보험 설계사 또는 보험사에 주택 보험 또는 세입자 보험 약관을 문의하여
            숙소에 대해 적절한 배상 책임 및 대물 피해 배상 관련 보장이
            적용되는지 확인하세요.{' '}
          </li>
        </ul>
        <p>
